...
class LearningProfileUserMapper(Mapper):
    ...
    def insert(self, learning_profile):
        ...
        command = "INSERT INTO learning_profile_user (id, user_id, name, prev_knowledge, extroversion, study_state, frequency," \
    ...
    def delete(self, learning_profile):
        ...
        cursor = self._cnx.cursor()
        command = "DELETE FROM learning_profile_user WHERE id = ('{}')".format(learning_profile.get_id())
        cursor.execute(command)
